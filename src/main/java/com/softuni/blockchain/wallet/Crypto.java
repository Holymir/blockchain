...
public class Crypto {
    ...
    public static ECPoint signedMessageToKey(String message, String signatureBase64) throws SignatureException {
        ...
        byte[] messageHash = sha256(sha256(messageBytes));
    ...
    public static ECPoint decode(String point) {
        return CURVE.getCurve().decodePoint(BaseEncoding.base16().decode(point));
    }
